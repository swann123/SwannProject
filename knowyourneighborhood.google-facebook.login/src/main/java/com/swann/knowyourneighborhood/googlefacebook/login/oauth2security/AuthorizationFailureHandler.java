package com.swann.knowyourneighborhood.googlefacebook.login.oauth2security;
...
import static com.swann.knowyourneighborhood.googlefacebook.login.oauth2security.HttpCookieAuthorizationRequestRepo.REDIRECT_URI_PARAM_COOKIE_NAME;
@Component
